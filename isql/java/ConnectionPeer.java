...
//////////////////////////////////////////////////////////////////////////
  ...
  public static Connection open(String database, String username, String password, String driver)
  {
    try
    {
      loadDriver(driver);
  ...
  public boolean isValid(Connection self){
    try
    {
      return jconn.isValid(5);
    }
    catch (SQLException e)
    {
      throw err(e);
...
//////////////////////////////////////////////////////////////////////////
  ...
  public long getCount(Connection self){
    return openCount;
  }
...
//////////////////////////////////////////////////////////////////////////
   ...
   */
  static void loadDriver(String driver)
  {
